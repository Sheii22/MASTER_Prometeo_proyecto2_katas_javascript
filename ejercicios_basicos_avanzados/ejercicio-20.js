...
function moreThan15Sales(pToys, popularToys){

    // Usa un bucle for...of para recorrer todos los juguetes ...
    for(const element of pToys){
    ...
    // Imprímelo por consola.
    console.log("Los jugueten que tienen más de 15 ventas son: ", popularToys);
}


// PRUEBA:

moreThan15Sales(toys, popularToys); 
    /* Los jugueten que tienen más de 15 ventas son:  
    [
        { id: 102, name: 'Tamagotchi', sellCount: 22 },
        { id: 104, name: 'Yo-yo', sellCount: 33 },
        { id: 105, name: 'Pikachu plush toy', sellCount: 19 },
